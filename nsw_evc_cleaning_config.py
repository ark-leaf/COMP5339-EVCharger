"""Task 2 column configuration; Task 3 lives in data_augmentation_config.py."""
...
from nsw_evc_data_cleaning import (
    address_processor, col_processor, charger_rating_processor, pcode_processor,
