...
from config import OCM_API_KEY, OCM_USER_AGENT, OCM_ENDPOINT, OCM_SNAPSHOT_FILE, OCM_SNAPSHOT_METADATA_FILE, \
    OCM_REFRESH_SNAPSHOT, TASK3_COORDINATE_PRECISION, TASK3_MAX_NEAR_DISTANCE_METRES, TASK3_MIN_NEAREST_GAP_METRES, \
    TASK3_OCM_SEARCH_RADIUS_KM, TASK3_OCM_SEARCH_MAXRESULTS, TASK3_OCM_REQUEST_DELAY_SECONDS, \
    TASK3_OCM_NSW_BOUNDING_BOX, TASK3_STREET_TYPE_ALIASES, TASK3_NUMBER_RE
